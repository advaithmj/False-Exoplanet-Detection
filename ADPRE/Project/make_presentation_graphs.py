#!/usr/bin/env python3
"""
Quick graph generator for science project presentation
Run this to create slide4_false_consensus.png and slide5_why_it_happened.png
"""
...
def main():
    ...
    print("Creating Graph 1 (Slide 4)...")
    ...
    plt.tight_layout()
    plt.savefig('slide4_false_consensus.png', dpi=150, bbox_inches='tight')
    ...
    print("Creating Graph 2 (Slide 5)...")
    ...
    # Add big explanation
    fig.text(0.5, 0.02, 'All detectors see the 7-day temperature pattern and think it\'s a planet!', 
             ha='center', fontsize=16, fontweight='bold', 
             bbox=dict(boxstyle='round,pad=0.8', facecolor='yellow', alpha=0.8))
    
    plt.tight_layout(rect=[0, 0.04, 1, 1])
    plt.savefig('slide5_why_it_happened.png', dpi=150, bbox_inches='tight')
    ...
    print()
    print("=" * 70)
    print("DONE! Both graphs created in current directory:")
    print("  1. slide4_false_consensus.png    → Use for SLIDE 4")
    print("  2. slide5_why_it_happened.png    → Use for SLIDE 5")
    print("=" * 70)
    print()
    print("Next: Insert these into your PowerPoint presentation!")
